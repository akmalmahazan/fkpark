...
$csrf = $_SESSION['csrf'];
    ...
    // Absolute base URL for QR + receipt links (PC scanning uses localhost)
    $absBase = 'http://localhost' . rtrim(dirname($_SERVER['SCRIPT_NAME']), '/\\');
                ...
                <table>
                    ...
                    <?php else: ?>
                        <?php while ($r = $list->fetch_assoc()):
                            ...
                            $qrUrl = $absBase . '/summon_view.php?id=' . $id;
