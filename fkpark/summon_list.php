...
<head>
    ...
    <style>
        * { box-sizing: border-box; font-family: system-ui, -apple-system, BlinkMacSystemFont, "Segoe UI", sans-serif; }
        ...
        /* Student Status button (different color from nav active red) */
        .btn-action.secondary { background: #ecfeff; border-color: #a5f3fc; color: #0e7490; }
        .btn-action.secondary:hover { background: #cffafe; }
    ...
    <aside class="sidebar">
        ...
        <nav class="nav">
            ...
            <a href="summon_list.php" class="nav-link active"><span class="icon">📄</span><span>Summons List</span></a>
                        <a href="student_status_security.php" class="nav-link"><span class="icon">👤</span><span>Student Status</span></a>
        ...
        <div class="content">
            ...
            <section class="panel">
                ...
                <table>
                    ...
                    <?php else: ?>
                        <?php
                            // Build absolute base URL for QR / receipt links (important for scanners)
                            $scheme = (!empty($_SERVER['HTTPS']) && $_SERVER['HTTPS'] !== 'off') ? 'https' : 'http';
                            $host = $_SERVER['HTTP_HOST'] ?? 'localhost';
                            $basePath = rtrim(dirname($_SERVER['SCRIPT_NAME']), '/\\'); // e.g. /fkpark/fkpark
                            $absBase = $scheme . '://' . $host . $basePath;
                        ?>
                        <?php foreach ($rows as $r):
                            $id = (int)$r['traffic_summonID'];
                            $receiptUrl = $absBase . "/summon_view.php?id={$id}";
                        ...
                        <tr>
                            ...
                            <td class="actions-col">
                                <div class="actions">
                                    ...
                                    <a class="btn-action secondary" href="student_status_security.php?student_id=<?= urlencode($r['student_id']) ?>">Student Status</a>
